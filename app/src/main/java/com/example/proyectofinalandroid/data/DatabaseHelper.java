...
import com.example.proyectofinalandroid.CreateDatabase; // Importar la clase CreateDatabase
...
public class DatabaseHelper {
    ...
    private final CreateDatabase dbHelper; // Usar CreateDatabase en lugar de SQLiteDatabase directamente
    private final Context context;

    public DatabaseHelper(Context context) {
        this.context = context;
        this.dbHelper = new CreateDatabase(context); // Inicializar CreateDatabase
    }
    ...
    // Método para insertar un residuo
    ...
    // Método para obtener el nombre de un usuario por su email
    ...
    // Método para obtener los residuos del día actual
    ...
    // Método para obtener los residuos por una fecha específica
    ...
    // Método para obtener una lista de residuos por fecha
    ...
    // Método para eliminar un residuo por usuario, tipo, fecha y peso
